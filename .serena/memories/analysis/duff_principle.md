...
verified_against: [docs/specification.md@HEAD §31-72, refs/plan9/papers/rc.ms@HEAD §Variables lines 107-200, refs/plan9/papers/rc.ms@HEAD §"Design Principles" lines 1329 1343-1344, audit/plan9-systems-engineer@2026-04-11]
---
...
- `docs/specification.md` §"Foundational commitment: every variable is a list" lines 31-58 — authoritative for psh's framing and the type-system extension.
- `docs/specification.md` §"rc's execution model as sequent calculus", **List-valued variables** bolded item (lines 66-72) — quotes Duff directly. (This is a bolded sub-bullet inside the larger section, not a standalone subsection.)
- `docs/specification.md` line 56: "This is Duff's principle extended across the type system: the list structure is carried as data, never destroyed and reconstructed."
