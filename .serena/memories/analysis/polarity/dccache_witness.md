...
importance: high
verified_against: [refs/ksh93/sfio-analysis/07-disciplines.md@HEAD §229-265, docs/specification.md@HEAD §133-169]
...
`docs/specification.md` §"The sfio insight" (line 133) cites this as the structural precedent for psh's polarity frame discipline.
