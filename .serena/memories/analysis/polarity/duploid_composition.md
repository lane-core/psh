...
- `docs/spec/` §"Polarity discipline" (line 343) — what the discipline enforces operationally.
- `docs/spec/` §"Theoretical framework §The semantics" (line 202) — Führmann-Thielecke citation.
